...
def generate_project_name(
    ...
    if os_version.is_sle15:
        ...
        res += "SLCC:" + str(os_version).split("-", 1)[1]
    else:
        res += str(os_version)
...
def generate_meta(
    ...
    with_helmcharts_repo = project_type == ProjectType.DEVEL and not os_version.is_slcc
    ...
    if os_version.is_sle15:
        ...
        repository_paths = (("SUSE:ALP:Source:Standard:Core:1.0:Build", "standard"),)
    ...
    if not os_version.is_slcc and project_type == ProjectType.DEVEL:
