...
class StagingBot:
    ...
    @property
    def _bcis(self) -> Generator[ObsPackageBase, None, None]:
    ...
    @property
    def bcis(self) -> Generator[ObsPackageBase, None, None]:
...
"""
    ...
    async def _write_pkg_meta(
        self, bci_pkg: ObsPackageBase, target_obs_project: str, git_branch_name
    ) -> None:
    ...
    async def write_pkg_configs(
        self,
        packages: Iterable[ObsPackageBase],
        git_branch_name: str,
    ...
    async def write_all_image_build_recipes(
        ...
        for bci in self.bcis:
            ...
            async def write_files(bci_pkg: ObsPackageBase, dest: str) -> list[str]:
