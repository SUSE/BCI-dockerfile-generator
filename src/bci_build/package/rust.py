...
_RUST_VERSIONS: list[str] = ["1.96", "1.97"]

_RUST_SL16_VERSIONS: list[str] = ["1.95", "1.96"]

_RUST_TW_VERSIONS: list[str] = ["1.96", "1.97"]
...
RUST_CONTAINERS = [
    DevelopmentContainer(
        ...
        additional_versions=(
            [f"{rust_version}-{os_version.dist_id}"] if os_version.dist_id else []
        ),
        env={
