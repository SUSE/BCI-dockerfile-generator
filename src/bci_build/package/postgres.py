...
from bci_build.package import Stable
...
# added 17 just for testing, will be supported only from 18
_STABLE_USER_GROUP_ID_SUPPORTED_VERSIONS = [17]
POSTGRES_CONTAINERS = [
    ApplicationStackContainer(
        ...
        if ver in _STABLE_USER_GROUP_ID_SUPPORTED_VERSIONS
        else None,
        custom_end=(
