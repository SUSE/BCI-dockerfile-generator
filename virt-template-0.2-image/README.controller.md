# The SUSE Linux KubeVirt virt-template controller container image
...
KubeVirt virt-template controller container based on the SUSE Linux Base Container Image.
