# The SUSE Linux KubeVirt virt-template apiserver container image
...
KubeVirt virt-template apiserver container based on the SUSE Linux Base Container Image.
