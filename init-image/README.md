# The SLE BCI Init 15 SP6 container image
...
Systemd environment for containers based on the SUSE Linux Enterprise Base Container Image. This container is only supported with podman.
