...
```ShellSession
$ podman run -d --rm -p 8080:8080 dp.apps.rancher.io/containers/apache-tomcat:9-openjdk21
```
...
$ podman run --rm -d -v /path/to/my/app:/usr/share/tomcat/webapps:z \
      -p 8080:8080 dp.apps.rancher.io/containers/apache-tomcat:9-openjdk21
```
...
$ podman run -it --rm \
      ...
      dp.apps.rancher.io/containers/apache-tomcat:9-openjdk21
```
