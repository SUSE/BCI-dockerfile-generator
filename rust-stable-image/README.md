...
FROM registry.opensuse.org/opensuse/bci/rust:1.89 as build
...
```ShellSession
$ podman run --rm -v "$PWD":/app:Z -w /app registry.opensuse.org/opensuse/bci/rust:1.89 cargo build --release
```
