# The SUSE Linux KubeVirt virt-synchronization-controller container image
...
KubeVirt virt-synchronization-controller container based on the SUSE Linux Base Container Image.
