...
```ShellSession
$ podman run -it --rm -p 5432:5432 -e POSTGRES_PASSWORD=my-password -v /path/to/data:/var/lib/pgsql/data:Z registry.suse.com/suse/postgres:18
```
...
$ podman run -it --rm
    ...
    registry.suse.com/suse/postgres:18
```
