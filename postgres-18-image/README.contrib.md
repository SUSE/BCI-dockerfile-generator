...
![Support Level](https://img.shields.io/badge/Support_Level-acc-blue)[![SLSA](https://img.shields.io/badge/SLSA_(v1.0)-Build_L3-Green)](https://documentation.suse.com/sbp/security/html/SBP-SLSA4/)
...
```ShellSession
$ podman run -it --rm -p 5432:5432 -e POSTGRES_PASSWORD=my-password -v /path/to/data:/var/lib/pgsql/data:Z registry.suse.com/suse/postgres:18-contrib
```
...
$ podman run -it --rm
    ...
    registry.suse.com/suse/postgres:18-contrib
```
