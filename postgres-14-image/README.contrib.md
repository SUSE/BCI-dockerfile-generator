...
```ShellSession
$ podman run -it --rm -p 5432:5432 -e POSTGRES_PASSWORD=my-password -v /path/to/data:/var/lib/pgsql/data:Z registry.opensuse.org/opensuse/postgres:14-contrib
```
...
$ podman run -it --rm
    ...
    registry.opensuse.org/opensuse/postgres:14-contrib
```
