...
```ShellSession
$ podman run -d --rm -p 8080:8080 dp.apps.rancher.io/containers/apache-tomcat:10.1-openjdk11
```
...
$ podman run --rm -d -v /path/to/my/app:/usr/share/tomcat/webapps:z \
      -p 8080:8080 dp.apps.rancher.io/containers/apache-tomcat:10.1-openjdk11
```
...
$ podman run -it --rm \
      ...
      dp.apps.rancher.io/containers/apache-tomcat:10.1-openjdk11
```
