...
# labelprefix=com.suse.bci.test
LABEL org.opencontainers.image.authors="https://github.com/SUSE/bci/discussions"
LABEL org.opencontainers.image.title="SL BCI DevelopmentContainer Test"
...
<image schemaversion="7.4" name="test-%%emacs_ver%%-image" xmlns:suse_label_helper="com.suse.label_helper">
  <description type="system">
    <author>SUSE LLC</author>
    <contact>https://www.suse.com/</contact>
    <specification>SL BCI DevelopmentContainer Test Container Image</specification>
  </description>
  <preferences>
    <type image="docker" derived_from="obsrepositories:/bci/bci-base#16.1">
      <containerconfig
        ...
        <labels>
          <suse_label_helper:add_prefix prefix="com.suse.bci.test">
            <label name="org.opencontainers.image.authors" value="https://github.com/SUSE/bci/discussions"/>
            <label name="org.opencontainers.image.title" value="SL BCI DevelopmentContainer Test"/>
