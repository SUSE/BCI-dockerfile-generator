...
```ShellSession
$ podman run -d --rm -p 8080:8080 registry.opensuse.org/opensuse/apache-tomcat:10.1.25-jre21
```
...
$ podman run --rm -d -v /path/to/my/app:/usr/share/tomcat/webapps:z \
      -p 8080:8080 registry.opensuse.org/opensuse/apache-tomcat:10.1.25-jre21
```
...
$ podman run -it --rm \
      ...
      registry.opensuse.org/opensuse/apache-tomcat:10.1.25-jre21
```
