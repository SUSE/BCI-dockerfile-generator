...
```ShellSession
$ podman run -it --rm -p 3389:3389 -p 3636:3636 registry.suse.com/suse/389-ds:3.1
```
...
```ShellSession
$ podman run -it --rm -v /my/own/datadir:/data:Z -p 3389:3389 -p 3636:3636 registry.suse.com/suse/389-ds:3.1
```
